...
async def create_checkout(
    ...
    success_url = "https://mediconsulta.app/billing/success?session_id={CHECKOUT_SESSION_ID}"
...
async def get_portal(
    ...
    """
    return {"portal_url": await s.create_portal_session(user["org"], "https://mediconsulta.app/billing")}
